...
$tab_cat = array('infoMoncoinAd','futurAd','supportAd','coordonneesAd');
...
function supportAd(){
    ...
    echo '<p>Vous pouvez contacter l\'entreprise pour être mis en relation avec le vendeur : <a href="/administrateur/footerAd?info=coordonneesAd">Coordonnées entreprise</a></p>';
    echo "<h4>Autre problème :</h4>";
    echo '<p>Pour tout autre soucis vous pouvez contacter l\'administrateur du site, ou l\'entreprise : <a href="/administrateur/footerAd?info=coordonneesAd">Coordonnées entreprise</a></p>';
    echo "</div>";
}
function coordonneesAd(){
