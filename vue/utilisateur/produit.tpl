...
if (count($_POST) != 0) {
    echo '<div id="choiceProduct">';
        ...
        echo '<div class="productChosen">';
            ...
            $add= strtotime($this->contentArray[0]['DateTime']);
            echo '<p> date ajout : '.date('d-m-Y', $add).'</p>';
            
            echo '<p class="prixProd"><span>Prix du produit : </span>'.$this->contentArray[0]['PrixProduit']."€";'</p>';
           
            echo '<div class="qteProd"><p>Quantité choisie : ';
            ?>
            ...
            echo '</div>';
            echo '<input id="totalQuantite"  type="hidden" name="totalQuantite" value='.$this->contentArray[0]['QteProduit'].'>';
             echo '<input id="monId"  type="hidden" name="idProduit" value='.$this->contentArray[0]['idProduit'].'>';
